...
redistribute the code under its terms — but the following naming rules apply on top of it.

## What you may do without permission

- Redistribute **unmodified** official builds under the original name, with clear attribution.
- Make truthful, nominative references, such as "based on", "a fork of", or "compatible with" this
  application, including a link to this repository.
...
To request an exception to this policy, please open an issue on this repository.
